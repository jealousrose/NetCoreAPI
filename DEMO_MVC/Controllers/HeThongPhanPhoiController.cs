...
namespace DEMO_MVC.Controllers
{
    public class HeThongPhanPhoiController : Controller
    {
        ...
        {
            return View(await _context.HeThongPhanPhoi_1.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var heThongPhanPhoi = await _context.HeThongPhanPhoi_1
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var heThongPhanPhoi = await _context.HeThongPhanPhoi_1.FindAsync(id);
            if (heThongPhanPhoi == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            if (heThongPhanPhoi != null)
            {
                _context.HeThongPhanPhoi_1.Remove(heThongPhanPhoi);
            }
        ...
        {
            return _context.HeThongPhanPhoi_1.Any(e => e.MaHTPP == id);
        }
    }
}
